<template>
    <div>
        ...
        <!-- /marry/a?a=1&b=2 -->
        <router-link style="display:block;margin-bottom:50px" to="/marry">to Marry</router-link>
        <el-button @click="replaceRoute" style="display:block;margin-bottom:50px">replace跳转</el-button>
        <i name="tree_main_server" style="color: red; font-size: 24px;" />
