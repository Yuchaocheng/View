import { throttle, grid, twoPointDistance } from '@/common/utils.js';
...
export default class DrawCanvas {
  constructor(canvas, bgCanvas, showCanvas) {
    this.canvas = canvas;
  ...
  init() {
    ...
    this.handleMouseMove = throttle(this.handleMouseMove, 16).bind(this);
  ...
  circle(x1, y1, x2, y2, isFill) {
    this.context.beginPath();
    let r = twoPointDistance(x1, y1, x2, y2);
